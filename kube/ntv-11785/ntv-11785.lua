...
{name="TNT",input={"dvb://adapter_1#pnr=1319&set_pnr=1210&cam=reader_6769"},output={"udp://ens1f0@239.192.16.19:2121#sync"},map="video=119,audio=1114",pnr="1319",udp_input={localaddr="172.17.168.11",addr="239.192.16.19",port="2121"}},
